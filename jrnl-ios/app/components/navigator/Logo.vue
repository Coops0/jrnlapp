  ...
  <div>
    ...
    >
      <div class="flex flex-col justify-items-center items-center gap-2">
        <span
            :id="logoId"
            class="fixed p-4 bottom-0 left-4 text-xl !leading-normal font-semibold text-colors-primary-100/70 hover:text-colors-primary-300 transition-all duration-150 ease-in-out select-none touch-none cursor-pointer z-10"
