<template>
  <div class="text-right relative">
    <div class="relative inline-block">
      ...
      <div
          class="absolute top-0 left-0 right-0 bottom-0 origin-right rounded-md cursor-pointer bg-opacity-30 bg-colors-primary-400 transition-all duration-300 hover:bg-opacity-60"
