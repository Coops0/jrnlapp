<template>
  <div class="text-right relative">
    <div class="relative inline-block">
      ...
      <div
          class="absolute top-0 left-0 right-0 bottom-0 origin-right cursor-pointer bg-opacity-30 bg-colors-primary-400 transition-[transform,opacity] duration-300"
